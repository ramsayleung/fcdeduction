...
bool fcdeduction::dao::ProductDao::productExist(
    ...
    return this->selectByPdCode(connection, tntInstId, pdCode).has_value();
}
std::optional<fcdeduction::dataobject::Product> fcdeduction::dao::ProductDao::selectByPdCode(sqlpp::mysql::connection& connection,
